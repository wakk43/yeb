<template>
  ...
  <div>
    <div style="display: flex;justify-content: center;margin-top: 10px">
      <el-input type="text" v-model="keywords" placeholder="通过用户名搜索用户..." prefix-icon="el-icon-search"
                size="small"
                style="width: 400px;margin-right: 10px" @change="doChange"></el-input>
    ...
    <div class="admin-container">
      <el-card class="admin-card" v-for="(admin,index) in admins" :key="index">
        ...
        <div class="userinfo-container">
          ...
          <div>
            用户角色：
            <el-tag type="success" size="small" style="margin-right: 4px" v-for="(role,indexj) in admin.roles"
...
export default {
  ...
  methods: {
    ...
    enabledChange(admin) {
      console.log(admin)
      this.putRequest('/system/admin/'+admin.id+'/'+admin.enabled).then(resp => {
        if (resp) {
          this.initAdmins();
        }
      })
